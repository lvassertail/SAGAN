...
class Generator(nn.Module):
    ...
    def __init__(self, image_size, z_dim=100, conv_dim=64):
        super(Generator, self).__init__()
        self.z_dim = z_dim
        self.imsize = image_size[1]
        layer1 = []
        layer2 = []
        layer3 = []
        last = []
...
def discriminator_loss_fn(d_out_real, d_out_fake, data_label=0, label_noise=0.0):
...
def generator_loss_fn(g_out_fake, data_label=0):
